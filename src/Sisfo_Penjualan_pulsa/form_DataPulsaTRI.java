 ...
 * @author ASUS
 */
public class form_DataPulsaTRI extends javax.swing.JFrame {

    /**
     * Creates new form form_DataPulsaTelkomsel
     */
    DefaultTableModel dtm;
    public form_DataPulsaTRI() {
        initComponents();
//        cmbpulsa.addItem("Pilihan");
    ...
    public void load_datatrireguler(){
     ...
     try{
            ...
            String sqldata1 = "SELECT * FROM tb_pulsatrireguler";
    ...
    public void load_datatridata(){
     ...
     try{
            Connection c = koneksi.getkoneksi();
            Statement stm = c.createStatement();
            String sqldata1 = "SELECT * FROM tb_pulsatridata";
            ResultSet res = stm.executeQuery(sqldata1);
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        if (cmbpulsa.getSelectedItem().equals("Reguler")){
            try{
                   Connection c = koneksi.getkoneksi();
                    String sqldata = "INSERT INTO `tb_pulsatrireguler` (`idpulsa`,`idoperator`, `namaoperator`, `namakartu`, `beli`, `jual`,`stock`, `jenispulsa`) VALUES "
...
//                    membersihkan();
       ...
       load_datatrireguler();
            ...
            try{
                   Connection c = koneksi.getkoneksi();
                    String sqldata = "INSERT INTO tb_pulsatridata(idpulsa, idoperator,namaoperator, namakartu, beli,jual,stock,jenispulsa) VALUES "
                            + "('"+txtpulsa.getText()+"','"+txtoperator.getText()+"','"+txtnamaoperator.getText()+"','"+txtnamakartu.getText()+"',"
                            + "'"+txtbeli.getText()+"','"+txtjual.getText()+"','"+txtstock.getText()+"','"+cmbpulsa.getSelectedItem()+"')";
                    PreparedStatement pst= c.prepareStatement(sqldata);
                    pst.execute();
...
//                    membersihkan();
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        if (cmbpulsa.getSelectedItem().equals("Reguler")){
                try{
                 Connection c = koneksi.getkoneksi();
                 String sql2 = "DELETE FROM `tb_pulsatrireguler` WHERE idpulsa = '"+txtpulsa.getText()+"';";
     ...
     //            membersihkan();
            ...
            try{
                 Connection c = koneksi.getkoneksi();
                 String sql2 = "DELETE FROM `tb_pulsatridata` WHERE idpulsa = '"+txtpulsa.getText()+"';";
                 PreparedStatement ps= c.prepareStatement(sql2);
                 ps.execute();
                 JOptionPane.showMessageDialog(null, "Data berhasil di hapus");
     //            membersihkan();
    ...
    private void btneditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneditActionPerformed
        if (cmbpulsa.getSelectedItem().equals("Reguler")){
            try {
            Connection c=koneksi.getkoneksi();
            String sqldata = "UPDATE tb_pulsatrireguler set idoperator=?, namaoperator=?, namakartu=?, beli=?, jual=?,stock=? jenispulsa=? where idpulsa=?";
            PreparedStatement pst=c.prepareStatement(sqldata);
           ...
           try {
            Connection c=koneksi.getkoneksi();
            String sqldata = "UPDATE tb_pulsatridata set idoperator=?, namaoperator=?, namakartu=?, beli=?, jual=?,stock=? where idpulsa=?";
            PreparedStatement pst=c.prepareStatement(sqldata);
            pst.setString(1, txtoperator.getText());
            pst.setString(2, txtnamaoperator.getText());
            pst.setString(3, txtnamakartu.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_DataPulsaTRI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_DataPulsaTRI().setVisible(true);
            }
        });
    }
