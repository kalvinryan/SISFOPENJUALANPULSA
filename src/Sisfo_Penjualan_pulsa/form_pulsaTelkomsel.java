 ...
 * @author ASUS
 */
public class form_pulsaTelkomsel extends javax.swing.JFrame {
...
//           String path="D:\\Project_Program\\New Folder\\Sisfo Penjualan Pulsa\\src\\Sisfo_Penjualan_pulsa\\rp_struck.jrxml";
...
//        }
    ...
    private void btntransferActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntransferActionPerformed
           try{
                    ...
                    if(cmbpulsa.getSelectedItem().equals("Reguler")){
                        ...
                        String sqldata2 = "UPDATE tb_pulsatelkomreguler set stock=? where idpulsa=?";
                        ...
                        c =koneksi.getkoneksi();
                        String sqldata2 = "UPDATE tb_pulsatelkomdata set stock=? where idpulsa=?";
                        pst=c.prepareStatement(sqldata2);
                        pst.setString(1, txtstock.getText());
                        pst.setString(2, txtidpulsa.getText());                  
                        pst.executeUpdate();  
        ...
        if(cmbpulsa.getSelectedItem().equals("Reguler")){
            ...
            int stock,jumlah;
               try{
                   Connection c =koneksi.getkoneksi();
                   Statement stm = c.createStatement();
                   String sqldata="select distinct * from tb_pulsatelkomreguler where beli like '%"+cmbharga.getSelectedItem()+"%'";
                   ResultSet res = stm.executeQuery(sqldata);
                   while(res.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form_pulsaTelkomsel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form_pulsaTelkomsel().setVisible(true);
            }
        });
    }
